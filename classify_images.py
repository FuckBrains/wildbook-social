...
'''Michelle - to create conda environments w/ specific dependency versions: https://docs.conda.io/projects/conda/en/latest/user-guide/getting-started.html
'''
'''
Michelle - dependencies with conda env "wildbookML":
pytorch==1.6.0
torchvision== 0.7.0
pretrainedmodels==0.7.4
pillow = 8.0.1##pillow==6.1.0
progressbar2==3.51.0
cupy-cuda100== VERSION NOT FOUND w/ cmd pip install cupy-cuda100==7.3.0
torchnet==0.0.4
''' 
...
## Michelle- change this to your local directory where you pulled the repo to
api_root= r'/Users/mramir71/Documents/GitHub/SpeciesClassification'
...
images_to_classify = r'/Users/mramir71/Documents/Github/wildbook-social-1/Classifier_Testing_Images/reticulated_giraffe_2.jpg' #r'/data/species-classification/images/sample_images.2019.12.28'

# Classification results will be written here
classification_output_file = '/Users/mramir71/Documents/Github/wildbook-social-1/species-classification/classification_output.csv'
...
##Michelle - trying to import api.py from DetectionClassification

# import api as speciesapi
from DetectionClassificationAPI import api as speciesapi
